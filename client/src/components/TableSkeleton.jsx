        ...
        {Array.from({ length: rows }).map((_, index) => (
          <div key={index} className="flex animate-pulse items-center gap-6 px-5 py-4">
            <div className="flex-1 space-y-2">
              <div className="h-3.5 w-40 rounded-ui bg-ink-200" />
              <div className="h-2.5 w-56 rounded-ui bg-ink-100" />
            </div>
            <div className="h-8 w-14 rounded-ui bg-ink-200" />
            <div className="hidden flex-1 gap-1.5 sm:flex">
              <div className="h-6 w-16 rounded-ui bg-ink-100" />
              <div className="h-6 w-20 rounded-ui bg-ink-100" />
            </div>
            <div className="h-8 w-20 rounded-ui bg-ink-100" />
          </div>
        ))}
      </div>
    </div>
